...
/* gucOS wasm port: force a rescan of the selected BLOCK_N — see the JV_PP_EXPAND
   note in jv.h for why this repo's preprocessor needs the extra pass. */
#ifndef BLOCK_PP_EXPAND
#define BLOCK_PP_EXPAND(x) x
#endif
#define BLOCK_IDX(_1,_2,_3,_4,_5,_6,_7,_8,NAME,...) NAME
#define BLOCK(...) \
  BLOCK_PP_EXPAND(BLOCK_IDX(__VA_ARGS__, BLOCK_8, BLOCK_7, BLOCK_6, BLOCK_5, BLOCK_4, BLOCK_3, BLOCK_2, BLOCK_1)(__VA_ARGS__))
