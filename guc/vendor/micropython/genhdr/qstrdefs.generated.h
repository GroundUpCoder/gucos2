...
QDEF1(MP_QSTR_abspath, 44056, 7, "abspath")
...
QDEF1(MP_QSTR_basename, 52951, 8, "basename")
...
QDEF1(MP_QSTR_curdir, 52062, 6, "curdir")
...
QDEF1(MP_QSTR_dirname, 50781, 7, "dirname")
...
QDEF1(MP_QSTR_expanduser, 818, 10, "expanduser")
...
QDEF1(MP_QSTR_getmtime, 32011, 8, "getmtime")
QDEF1(MP_QSTR_getrandbits, 32102, 11, "getrandbits")
QDEF1(MP_QSTR_getsize, 26966, 7, "getsize")
...
QDEF1(MP_QSTR_lexists, 64457, 7, "lexists")
...
QDEF1(MP_QSTR_lstat, 22683, 5, "lstat")
...
QDEF1(MP_QSTR_normpath, 55958, 8, "normpath")
...
QDEF1(MP_QSTR_pardir, 54713, 6, "pardir")
...
QDEF1(MP_QSTR_readlink, 6647, 8, "readlink")
QDEF1(MP_QSTR_real, 63935, 4, "real")
QDEF1(MP_QSTR_realpath, 2098, 8, "realpath")
...
QDEF1(MP_QSTR_splitext, 13054, 8, "splitext")
...
QDEF1(MP_QSTR_symlink, 26338, 7, "symlink")
