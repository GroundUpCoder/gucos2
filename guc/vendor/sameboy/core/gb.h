...
struct GB_gameboy_internal_s {
    ...
    GB_SECTION(unsaved,
        ...
        /* PATCH(c-compiler): #ifndef GB_DISABLE_DEBUGGER block removed — always disabled in
           this build; the preprocessor cannot embed directives in macro args */

        /* PATCH(c-compiler): #ifndef GB_DISABLE_REWIND block removed — always disabled in
           this build; the preprocessor cannot embed directives in macro args */
        ...
        /* PATCH(c-compiler): #ifndef GB_DISABLE_CHEATS block removed — always disabled in
           this build; the preprocessor cannot embed directives in macro args */
        /* PATCH(c-compiler): #ifndef GB_DISABLE_CHEAT_SEARCH block removed — always disabled in
           this build; the preprocessor cannot embed directives in macro args */
