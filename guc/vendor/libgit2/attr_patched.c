...
{
	git_attr_file_source source;
	source.type = GIT_ATTR_FILE_SOURCE_FILE;
	source.base = NULL;
	source.filename = NULL;
	source.commit_id = NULL;
	...
	git_attr_options *opts)
{
	...
	git_attr_file_source index_source;
	index_source.type = GIT_ATTR_FILE_SOURCE_INDEX;
	index_source.base = NULL;
	index_source.filename = GIT_ATTR_FILE;
	index_source.commit_id = NULL;
	git_attr_file_source head_source;
	head_source.type = GIT_ATTR_FILE_SOURCE_HEAD;
	head_source.base = NULL;
	head_source.filename = GIT_ATTR_FILE;
	head_source.commit_id = NULL;
	git_attr_file_source commit_source;
	commit_source.type = GIT_ATTR_FILE_SOURCE_COMMIT;
	commit_source.base = NULL;
	commit_source.filename = GIT_ATTR_FILE;
	commit_source.commit_id = NULL;
